...
public class CcsClient {
	...
	public static final Logger logger = Logger.getLogger(CcsClient.class
			.getName());
	...
	private static CcsClient sInstance;
	...
	public static void main(String[] args) {
		final String projectId = "365734933247";
		final String apiKey = "AIzaSyCzjS_xlNSdeSuWtzPL3BPto9qFnImXewo";

		CcsClient ccsClient = CcsClient.prepareClient(projectId, apiKey, true);
